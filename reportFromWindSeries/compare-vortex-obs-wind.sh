...
echo "R --vanila --slave --quiet --no-restore --args ${args} < info4points-wind.R "
R --vanilla --slave --quiet --no-restore  --no-save  --args ${args} < /home/oriol/SRC/validateAndgraph-wind/info4points-wind.R 
#CLEAN
